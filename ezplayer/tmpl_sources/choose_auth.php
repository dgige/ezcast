...
<?php } ?>
        <div class="container">
            ...
            <div class="contenu">
                ...
                <br />
                <h2>®ezplayer_welcome_title®</h2>
                <a href="<?php global $ezplayer_safe_url; echo $ezplayer_safe_url; ?>/index.php?action=internal_login">®ezplayer_login_via_db®</a>
                <a href="<?php global $ezplayer_safe_url; echo $ezplayer_safe_url; ?>/index.php?action=cas_login">®ezplayer_login_via_cas®</a>
            </div>
        </div>
    </body>
</html>